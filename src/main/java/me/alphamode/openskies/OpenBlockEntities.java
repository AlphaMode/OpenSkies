...
public class OpenBlockEntities implements AutoRegistryContainer<BlockEntityType<?>> {
    public static final BlockEntityType<InfestedLeavesBlockEntity> INFESTED_LEAVES = FabricBlockEntityTypeBuilder.create(InfestedLeavesBlockEntity::new, OpenBlocks.INFESTED_LEAVES).build();
    @IterationIgnored
