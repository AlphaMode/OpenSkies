...
public class SkyblockSkyRenderer {
    ...
    private static final ResourceLocation textureSkybox = new ResourceLocation(AbsentiaTextures.MISC_SKYBOX);
    private static final ResourceLocation textureRainbow = new ResourceLocation(AbsentiaTextures.MISC_RAINBOW);
    private static final ResourceLocation[] planetTextures = new ResourceLocation[] {
            new ResourceLocation(AbsentiaTextures.MISC_PLANET + "0.png"),
            new ResourceLocation(AbsentiaTextures.MISC_PLANET + "1.png"),
            new ResourceLocation(AbsentiaTextures.MISC_PLANET + "2.png"),
            new ResourceLocation(AbsentiaTextures.MISC_PLANET + "3.png"),
            new ResourceLocation(AbsentiaTextures.MISC_PLANET + "4.png"),
            new ResourceLocation(AbsentiaTextures.MISC_PLANET + "5.png")
    };
